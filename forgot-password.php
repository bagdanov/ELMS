    ...
    <div class="col-md-3"></div>
                          <div class="col-md-6 d-flex justify-content-center align-items-center">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content" id="myForm">
...
foreach ($results as $result) {
  ...
  <div class="card-content">
                                    <span class="card-title text-danger" style="font-size:20px;">Change your password </span>     
 <div class="row">
...
<div class="col s12 right-align m-t-sm">
<button type="submit" name="change" class="waves-effect waves-light btn indigo m-b-xs" onclick="return valid();" style="width: 189.28px;">Change</button>
